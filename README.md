...
```
#### Note: please keep pip version < 24.0, if your pip version ≥ 24.0 that can't download pytorch_lightning==1.6.3. If you download pytorch_lightning != 1.6.3, please change the ```gpus``` setting of trainer.
---
