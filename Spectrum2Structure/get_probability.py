...
# define the model
model=GPT.load_from_checkpoint("./checkpoints/GPT-epoch=64-step=20150.00.ckpt")
...
np.savez('GPT-predictions.npz', predictions=predictions, targets=predicition_targets)
